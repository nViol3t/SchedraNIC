...
(
   ...
   input    logic [SINGLE_DATA_WITHOUT_COUNTER-1:0]            Child_Pop_resp_Data  ,
   //Addr Io
 ...
 //  logic                               ram_rden       ;
   ...
   //Push From Top 
   //Pop from Top    
   logic                                     Parents_Pop_resp_valid_reg ;
   logic [SINGLE_DATA_WITHOUT_COUNTER-1:0]   Parents_Pop_resp_Data_reg  ; 
   //Push to Child      
   logic                                     Child_Push_valid_reg     ;
   logic [SINGLE_DATA_WITHOUT_COUNTER-1:0]   Child_Push_Data_reg      ;
   //Pop  to Child
...
//      四级比较器，选择最小PTW值
   ...
   always_comb begin
      ...
      if(Push_Req_pipe_out)begin
         ...
         ram_wren                          = 1'b1 ;
         Write_ram_data_Without_cnt        = min_sub_tree_ram_rank <= Push_Req_Data_pipe_out_data_rank ? min_sub_tree_ram_word_without_cnt : 
                                                                     Push_Req_Data_pipe_out ;      //< to <=
