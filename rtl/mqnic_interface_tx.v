...
tx_engine_inst (
    ...
    // Transmit request output to scheduler
    .m_axis_tx_req_valid(m_axis_tx_req_valid),
    .m_axis_tx_req_ready(m_axis_tx_req_ready),
    //Transmit request input from scheduler
    .s_axis_tx_resp_queue(s_axis_tx_resp_queue),
    .s_axis_tx_resp_wqe(s_axis_tx_resp_wqe),
    .s_axis_tx_resp_dest(s_axis_tx_resp_dest),
    .s_axis_tx_resp_valid(s_axis_tx_resp_valid),
    .s_axis_tx_resp_ready(s_axis_tx_resp_ready),
    

    //Descriptor request output to desc_fetch through desc_op_mux
    .m_axis_desc_req_queue(m_axis_desc_req_queue),
    .m_axis_desc_req_wqe(m_axis_desc_req_wqe),
    ...
    // Transmit descriptor output (inside)
