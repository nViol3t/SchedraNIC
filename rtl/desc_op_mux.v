...
(
    ...
    input  wire [PORTS*WQE_WIDTH-1:0]             s_axis_req_wqe,
    ...
    output wire [WQE_WIDTH-1:0]                   m_axis_req_wqe,
...
reg [PORTS*WQE_WIDTH-1:0]         s_axis_req_wqe_reg = 0;
...
reg  [WQE_WIDTH-1:0]         m_axis_req_wqe_int;
...
wire [WQE_WIDTH-1:0]         current_s_desc_wqe   = s_axis_req_wqe_reg[grant_encoded*WQE_WIDTH +: WQE_WIDTH];
...
always @* begin
    ...
    m_axis_req_wqe_int   = current_s_desc_wqe;
...
always @(posedge clk) begin
    ...
    for (i = 0; i < PORTS; i = i + 1) begin
        if (s_axis_req_ready[i]) begin
            ...
            s_axis_req_wqe_reg[i*WQE_WIDTH +: WQE_WIDTH] <= s_axis_req_wqe[i*WQE_WIDTH +: WQE_WIDTH];
...
reg [WQE_WIDTH-1:0]         m_axis_req_wqe_reg   = {WQE_WIDTH{1'b0}};
...
reg [WQE_WIDTH-1:0]         temp_m_axis_req_wqe_reg   = {WQE_WIDTH{1'b0}};
...
assign m_axis_req_wqe   = m_axis_req_wqe_reg;
...
always @(posedge clk) begin
    ...
    if (store_axis_int_to_output) begin
        ...
        m_axis_req_wqe_reg <= m_axis_req_wqe_int;
        ...
        m_axis_req_wqe_reg <= temp_m_axis_req_wqe_reg;
    ...
    if (store_axis_int_to_temp) begin
        ...
        temp_m_axis_req_wqe_reg <= m_axis_req_wqe_int;
