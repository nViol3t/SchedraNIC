    ...
    for (n = 0; n < SEG_COUNT; n = n + 1) begin
        ...
        always @(posedge clk) begin
            ...
            if (dma_ram_rd_cmd_valid[n] && dma_ram_rd_cmd_ready[n]) begin //?
                ...
                dma_ram_rd_resp_data_pipe_reg[0] <= {
                    desc_table_phase[dma_ram_rd_cmd_addr[SEG_ADDR_WIDTH*n +: CL_DESC_TABLE_SIZE]], 
                    desc_table_data[dma_ram_rd_cmd_addr[SEG_ADDR_WIDTH*n +: CL_DESC_TABLE_SIZE]][CPL_SIZE*8-1-1:0]
                } >> SEG_DATA_WIDTH*n;
            end
