...
(
     ...
     */
    output wire                                m_axis_cpl_req_queue,
    output wire [TX_TAG_WIDTH-1:0]             m_axis_cpl_req_tag,
    output wire [31:0]                         m_axis_cpl_req_data,
    output wire                                m_axis_cpl_req_valid,
    input  wire                                m_axis_cpl_req_ready,

    /*
     * Completion request status interface
     */
    input  wire [TX_TAG_WIDTH-1:0]             s_axis_cpl_req_status_tag,
