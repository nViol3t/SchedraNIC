...
async def run_test_nic(dut):
    ...
    for interface in tb.driver.interfaces:
        ...
        await interface.start_xmit(data, 0, rank = 0x1000, wqe = 1)
    ...
    if tb.driver.interfaces[0].if_feature_tx_csum:
        ...
        await tb.driver.interfaces[0].start_xmit(test_pkt2.build(), 0, 34, 6, 0x1000, 1)
    else:
        await tb.driver.interfaces[0].start_xmit(test_pkt.build(), 0, rank = 0x1000, wqe = 1)
    ...
    for k in range(4):
        ...
        await tb.driver.interfaces[0].start_xmit(data, k % len(tb.driver.interfaces[0].txq), rank = 0x1000, wqe = 1)
    ...
    if tb.driver.interfaces[0].if_feature_rss:
        ...
        for k in range(64):
            ...
            if tb.driver.interfaces[0].if_feature_tx_csum:
                ...
                await tb.driver.interfaces[0].start_xmit(test_pkt2.build(), k % len(tb.driver.interfaces[0].txq), 34, 6, rank = 0x1000, wqe = 1)
            else:
                await tb.driver.interfaces[0].start_xmit(test_pkt.build(), k % len(tb.driver.interfaces[0].txq), rank = 0x1000, wqe = 1)
    ...
    for p in range(count):
        await tb.driver.interfaces[0].start_xmit(pkts[p],  p % len(tb.driver.interfaces[0].txq), rank = 0x1000, wqe = 1)
    ...
    for k in range(count):
        await tb.driver.interfaces[0].start_xmit(pkts[k], k % len(tb.driver.interfaces[0].txq),rank = 0x1000, wqe = 1)
    ...
    count = len(tb.driver.interfaces[0].txq)
    ...
    for k in range(count):
        await tb.driver.interfaces[0].start_xmit(pkts[k], k,rank = 0x1000, wqe = 1)
        await tb.driver.interfaces[0].start_xmit(pkts[k], k,rank = 0x1000, wqe = 1)
    ...
    tb.log.info("Local Flow Control test")
